namespace ResourceInformationV2.Search.Models {
    ...
    public class Event : BaseObject {
        ...
        internal override string[] Headings => ["Id", "Title", "Description", "Start Date", "End Date", "Is All Day", "Location", "Speaker", "Sponsor", "Fragment", "Url", "Image", "Image Alt Text", "Image Source", "Video Url", "Notes", "Created Date", "Is Active", "Audience List", "Topic List", "Tag 1 List", "Tag 2 List", "Tag 3 List", "Tag 4 List", "Related Links", "Order", "Review Email", "Last Updated Date"];

        internal override bool LoadFromStringPrivate(string[] lineArray) {
            Id = lineArray[0];
            Title = lineArray[1];
            Description = lineArray[2];
            _ = DateTime.TryParse(lineArray[3], out var startDate);
            StartDate = startDate == default ? DateTime.Now : startDate;
            _ = DateTime.TryParse(lineArray[4], out var endDate);
