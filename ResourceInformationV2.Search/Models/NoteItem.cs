namespace ResourceInformationV2.Search.Models {
    ...
    public class NoteItem : BaseObject {
        ...
        internal override string[] Headings => ["Id", "Title", "Description", "Detail Text", "Fragment", "Url", "Image", "Image Alt Text", "Image Source", "Video Url", "Notes", "Created Date", "Is Active", "Audience List", "Topic List", "Tag 1 List", "Tag 2 List", "Tag 3 List", "Tag 4 List", "Related Links", "Order", "Review Email", "Last Updated Date"];
